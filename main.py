...
async def account_login(bot: Client, m: Message):
    ...
    await editable.edit("Now send the Thumb url/nEg » https://graph.org/file/eb18b59310300916efdd0.jpg \n Or if don't want thumbnail send = no")
